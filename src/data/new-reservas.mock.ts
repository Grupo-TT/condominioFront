...
export const generateNewReservasMock = (): IEventExtended[] => {
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Salón de Eventos', 'Zona'),
    tipoRecurso: 'Zona',
    numeroInvitados: 25,
    casaNumero: '302',
    estado: 'aprobada',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Piscina', 'Zona'),
    tipoRecurso: 'Zona',
    numeroInvitados: 15,
    casaNumero: '303',
    estado: 'aprobada',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Gimnasio', 'Zona'),
    tipoRecurso: 'Zona',
    numeroInvitados: 12,
    casaNumero: '304',
    estado: 'aprobada',
  ...
  reservas.push({
    ...
    user: { id: '302', name: 'Juan Pérez', picturePath: null },
    recursoComun: createRecursoComun('Proyector', 'Objeto'),
    tipoRecurso: 'Objeto',
    numeroInvitados: 1,
    casaNumero: '302',
    estado: 'pendiente',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Cancha Deportiva', 'Zona'),
    tipoRecurso: 'Zona',
    numeroInvitados: 20,
    casaNumero: '305',
    estado: 'aprobada',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('BBQ/Parrilla', 'Zona'),
    tipoRecurso: 'Zona',
    numeroInvitados: 30,
    casaNumero: '301',
    estado: 'aprobada',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Sillas Plegables', 'Objeto'),
    tipoRecurso: 'Objeto',
    numeroInvitados: 1,
    casaNumero: '306',
    estado: 'pendiente',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Mesas Plegables', 'Objeto'),
    tipoRecurso: 'Objeto',
    numeroInvitados: 1,
    casaNumero: '310',
    estado: 'aprobada',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Área de Niños', 'Zona'),
    tipoRecurso: 'Zona',
    numeroInvitados: 18,
    casaNumero: '311',
    estado: 'pendiente',
  ...
  reservas.push({
    ...
    recursoComun: createRecursoComun('Sala de Juegos', 'Zona'),
    tipoRecurso: 'Zona',
    numeroInvitados: 16,
    casaNumero: '318',
    estado: 'aprobada',
